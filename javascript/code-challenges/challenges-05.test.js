...
const returnNames = (arr) => {
  // Solution code here...
  return arr.reduce((nameArr, element) => {
...
const reversedString = (str) => {
  ...
  return charArr.reduce((newStr, element) => {
...
const calculateAverage = (arr) => {
  // Solution code here...
  //return arr.reduce((avg, element) => avg = (avg + element) / arr.findIndex(element), 0);
  let sum = arr.reduce((avg, element) => avg += element, 0);
...
const countPrimeNumbers = (arr) => {
  // Solution code here...
  return arr.reduce((count, element) => isPrime(element) ? count+=1 : count += 0, 0);
};
...
const extractStats = (snorlaxData) => {
  // Solution code here...
  return snorlaxData.stats.reduce((statObj, element) => {
...
const extractChildren = (arr) => {
  // Solution code here...
  let newArr = arr.filter(element => element.name.includes('a'));
  return newArr.reduce((childArr, element) => {
    if(element.children)
    {
      element.children.forEach(element => childArr.push(element));
    }
    return childArr;
  }, []);
